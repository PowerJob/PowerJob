...
-- ----------------------------
DROP TABLE IF EXISTS `sx_app_info`;
CREATE TABLE `sx_app_info`
(
...
DROP TABLE IF EXISTS `sx_container_info`;
CREATE TABLE `sx_container_info`
(
...
-- ----------------------------
DROP TABLE IF EXISTS `sx_instance_info`;
CREATE TABLE `sx_instance_info`
(
...
-- ----------------------------
DROP TABLE IF EXISTS `sx_job_info`;
CREATE TABLE `sx_job_info`
(
...
-- ----------------------------
DROP TABLE IF EXISTS `sx_oms_lock`;
CREATE TABLE `sx_oms_lock`
(
...
-- ----------------------------
DROP TABLE IF EXISTS `sx_server_info`;
CREATE TABLE `sx_server_info`
(
...
-- ----------------------------
DROP TABLE IF EXISTS `sx_user_info`;
CREATE TABLE `sx_user_info`
(
    ...
    `gmt_modified` datetime     not NULL COMMENT '更新时间',
    PRIMARY KEY (`id`),
    unique index uidx01_sx_user_info (username),
    unique index uidx02_sx_user_info (email)
) ENGINE = InnoDB
  DEFAULT CHARSET = utf8mb4
...
-- ----------------------------
DROP TABLE IF EXISTS `sx_workflow_info`;
CREATE TABLE `sx_workflow_info`
(
...
-- ----------------------------
DROP TABLE IF EXISTS `sx_workflow_instance_info`;
CREATE TABLE `sx_workflow_instance_info`
(
...
-- ----------------------------
DROP TABLE IF EXISTS `sx_workflow_node_info`;
CREATE TABLE `sx_workflow_node_info`
(
