...
public class TypeStore {
    ...
    public static final TypeReference<ResultDTO<List<WorkflowInstanceInfoDTO>>> LIST_WF_INSTANCE_RESULT_TYPE = new TypeReference<ResultDTO<List<WorkflowInstanceInfoDTO>>>() {};
