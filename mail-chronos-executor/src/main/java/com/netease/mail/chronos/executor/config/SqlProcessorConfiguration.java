...
public class SqlProcessorConfiguration {
    ...
    public DataSource sqlProcessorDataSource() {
        String path =  System.getProperty("user.home") + "/chronos/h2/" + CommonUtils.genUUID() + "/";
        String jdbcUrl = String.format("jdbc:h2:file:%schronos_sql_processor_db;DB_CLOSE_DELAY=-1;DATABASE_TO_UPPER=false", path);
