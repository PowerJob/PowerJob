...
public class NetUtils {
    ...
    private static final String BIND_LOCAL_ADDRESS = "network.local.address";
    private static final String PREFERRED_NETWORK_INTERFACE = "network.interface.preferred";
    public static final String IGNORED_NETWORK_INTERFACE_REGEX = "network.interface.ignored";
    ...
    public static String getLocalHost() {
        ...
        String addressFromJvm = System.getProperty(BIND_LOCAL_ADDRESS);
        if (StringUtils.isNotEmpty(addressFromJvm)) {
            log.info("[Net] use address from[{}]: {}",BIND_LOCAL_ADDRESS, addressFromJvm);
     ...
     * the property value from {@link NetUtils#PREFERRED_NETWORK_INTERFACE}, return <code>true</code>,
     * or <code>false</code>
     */
